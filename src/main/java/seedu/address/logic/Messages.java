...
public class Messages {
    ...
    public static final String MESSAGE_INVALID_EMPLOYEE_DISPLAYED_UID = "The employee UID provided is invalid";
    ...
    public static final String MESSAGE_INVALID_TASK_DISPLAYED_INDEX = "The task index provided is invalid. Valid task indexes are from 1 to the number of tasks in the employee's todo list.";
